(() => {
  ...
  window.PORTFOLIO_PAGE_DATA["unit-10-appendices"] = {
    ...
    ar: {
      ...
      overview: {
        title: "نظرة عامة على الملاحق",
        body: [
          "تشير هذه الملاحق إلى اكتمال تنفيذ دروس وحدة الروبوتات، حيث تتضمن نماذج متنوعة من خطط دروس الوحدة، والأنشطة الداعمة للتعلم، وأدوات التقويم المستخدمة أثناء التطبيق، بما في ذلك قواعد وأسس التصحيح الخاصة بها.",
