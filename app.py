...
NAV_STRUCTURE = [
    ...
    {'id': 'philosophy'},
    {'id': 'cv'},
    {'id': 'unit-plan', 'children': ['unit-1-intro', 'unit-2-framework', 'unit-3-objectives', 'unit-4-assessment', 'unit-5-lessons', 'unit-6-feedback', 'unit-7-impact', 'unit-8-reflection', 'unit-9-references', 'unit-10-appendices']},
    {'id': 'framework-axes'},
    {'id': 'reflection-papers'},
    {'id': 'graduation-project'},
    {'id': 'other', 'children': ['other-values', 'other-workshop', 'other-growth', 'other-peer-visits', 'other-parent-communication']}
]

NAV_ICONS = {
    'home': '&#8962;', 'philosophy': '&#9673;', 'cv': '&#9638;',
    'unit-plan': '&#9635;', 'framework-axes': '&#8998;',
    'reflection-papers': '&#9998;', 'graduation-project': '&#11041;', 'other': '&#8230;'
}

ROUTE_MAP = {
    'home': 'home', 'philosophy': 'philosophy', 'cv': 'cv',
    'unit': 'unit-plan', 'framework': 'framework-axes',
    'reflections': 'reflection-papers', 'graduation': 'graduation-project',
    'other': 'other', 'unit1': 'unit-1-intro', 'unit2': 'unit-2-framework',
    'unit3': 'unit-3-objectives', 'unit4': 'unit-4-assessment',
    'unit5': 'unit-5-lessons', 'unit6': 'unit-6-feedback',
    'unit7': 'unit-7-impact', 'unit8': 'unit-8-reflection',
    'unit9': 'unit-9-references', 'unit10': 'unit-10-appendices',
    'other1': 'other-values', 'other2': 'other-workshop',
    'other3': 'other-growth', 'other4': 'other-peer-visits',
...
def page(page_id):
    ...
    return render_template(f'pages/{page_id}.html', **get_page_context(page_id))
